    ...
    return (
      <div className="login-box d-flex align-items-center">
        <div className="login-box__box mx-auto bg-dark pb-3 col-4 rounded">
          <h1 className="login-box__title text-center pb-1 my-3">B<span className="text-light">oilerplate</span></h1>
          <p className="lead text-center text-secondary">Boilerplate phrase</p>
