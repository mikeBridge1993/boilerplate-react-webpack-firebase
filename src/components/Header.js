...
export const Header = (props) => (
  <header>
    <nav className="navbar navbar-expand-sm navbar-dark ">
      <Link to="/dashboard" activeclassname="is-active" className="navbar-brand text-secondary ml-3"><span>Xpensify</span></Link>
      ...
      <div className="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <button onClick={props.startLogout} className=" btn btn-danger btn-logout mr-3">Logout</button>
      </div>
    </nav>
  </header>
);
